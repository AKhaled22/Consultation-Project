...
const Login = () => {
    ...
    useEffect(() => {
        ...
        // .then((data) => {
            ...
            const handleLoginSubmit = async (values) => {
                try{
                    const res = await axios.post("http://localhost:3001/api/user/login",values)
                    // console.log(res);
                    if(res.status === 200){
    ...
    return (
        <div>
            ...
            <MyForm handleSub = {handleLoginSubmit} type="login" inputArr={inputArr} title="Login" buttText="Login" />
